...
class InformCheckStatusPage extends StatefulWidget {
 int _dormId;
  String _userName;
  InformCheckStatusPage(int dormId, String userName) {
    this._dormId = dormId;
    this._userName = userName;
  }
  @override
  State<StatefulWidget> createState() {
    return new _InformCheckStatusPage(_dormId, _userName);
  }
}
...
class _InformCheckStatusPage extends State<InformCheckStatusPage> {
  ...
  _InformCheckStatusPage(int dormId, String userName) {
    this._dormId = dormId;
    this._userName = userName;
  }
            ...
            child: new Column(
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    new Container(
                      padding: EdgeInsets.only(left: 20, right: 5,bottom: 20,top: 20),
