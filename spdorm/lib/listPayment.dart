...
class ListPaymentPage extends StatefulWidget {
  ...
  ListPaymentPage(int dormId, int customerId, int roomId) {
    this._dormId = dormId;
    this._roomId = roomId;
  ...
  State<StatefulWidget> createState() {
    return new _ListPaymentPage(_dormId, _customerId, _roomId);
  }
}

class _ListPaymentPage extends State<ListPaymentPage> {
  int _dormId, _roomId, _customerId;
  _ListPaymentPage(int dormId, int customerId, int roomId) {
    this._dormId = dormId;
    this._roomId = roomId;
    this._customerId = customerId;
  }
